// Markdown → Slack mrkdwn conversion adapted from goclaw:
// https://github.com/nextlevelbuilder/goclaw/blob/main/internal/channels/slack/format.go
//
// Pipeline order (must be preserved): HTML → protect Slack tokens → escape &<> →
// code fences → inline code → tables as fenced blocks → link/bold/strike/header.
