...
func CreateSessionWorkspace(workspacesRoot, teamID, channelID, rootThreadTS, uniqueSuffix, templatePath, agentFilename, appendPrompt, slackMrkdwnGuideSrc string, sessionBot SessionBotIdentity) (string, error) {
